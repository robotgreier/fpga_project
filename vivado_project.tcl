...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/main/dopamine_loader.sv"]"\
 ...
 "[file normalize "$origin_dir/src/main/packer.sv"]"\
 "[file normalize "$origin_dir/src/main/reset_sync.sv"]"\
 "[file normalize "$origin_dir/src/main/spike_loader.sv"]"\
 "[file normalize "$origin_dir/src/SNN_core/synapse_core/synapse_core.sv"]"\
 "[file normalize "$origin_dir/src/main/timer.sv"]"\
 ...
 "[file normalize "$origin_dir/src/SNN_core/synapse_core/eligibility_updater.sv"]"\
 "[file normalize "$origin_dir/src/SNN_core/synapse_core/synapse_core.sv"]"\
 "[file normalize "$origin_dir/src/SNN_core/tb_functional_comparison.sv"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7a100tcsg324-2 -quiet -force
...
set_property -name "simulator.modelsim_version" -value "2025.2" -objects $obj
set_property -name "simulator.questa_gcc_version" -value "7.4.0" -objects $obj
set_property -name "simulator.questa_version" -value "2025.2" -objects $obj
set_property -name "simulator.riviera_gcc_version" -value "9.3.0" -objects $obj
set_property -name "simulator.riviera_version" -value "2024.10" -objects $obj
set_property -name "simulator.vcs_gcc_version" -value "9.2.0" -objects $obj
set_property -name "simulator.vcs_version" -value "X-2025.06" -objects $obj
set_property -name "simulator.xcelium_gcc_version" -value "9.3.0" -objects $obj
set_property -name "simulator.xcelium_version" -value "25.03.002" -objects $obj
set_property -name "simulator.xsim_gcc_version" -value "9.3.0" -objects $obj
set_property -name "simulator.xsim_version" -value "2025.2" -objects $obj
...
set_property -name "webtalk.xsim_launch_sim" -value "679" -objects $obj
...
set file "$origin_dir/src/main/dopamine_loader.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/main/packer.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/main/reset_sync.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/main/timer.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/Arty-A7-100-Master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/Arty-A7-100-Master.xdc"
set file [file normalize $file]
...
set file "$origin_dir/src/SNN_core/tb_functional_comparison.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "tb_functional_comparison" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
set_property -name "xsim.elaborate.xelab.more_options" -value "-mt off -L xil_defaultlib" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a100tcsg324-2 -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
