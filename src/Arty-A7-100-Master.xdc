...
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { packer_transmit_led }]; #IO_L21P_T3_DQS_35 Sch=led1_g
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { packer_err_empty_led }]; #IO_L20N_T3_35 Sch=led1_r

# FIFO in
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { fifo_in_empty_led }]; #IO_L21N_T3_DQS_35 Sch=led2_b
#set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { led2_g }]; #IO_L22N_T3_35 Sch=led2_g
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { fifo_in_full_led }]; #IO_L22P_T3_35 Sch=led2_r

# FIFO out
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { fifo_out_empty_led }]; #IO_L23P_T3_35 Sch=led3_b
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { led3_g }]; #IO_L24P_T3_35 Sch=led3_g
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { fifo_out_full_led }]; #IO_L23N_T3_35 Sch=led3_r

## LEDs
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports {spk_out_led[0]}]
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports {spk_out_led[1]}]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports {spk_out_led[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {spk_out_led[3]}]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd_out }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { uart_txd_in }]; #IO_L4P_T0_15 Sch=ja[2]
...
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd_out }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { uart_txd_in }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
...
## USB-UART Interface
#set_property -dict {PACKAGEPIN D10 IOSTANDARD LVCMOS33} [get_ports uart_rxd_out]
...
## Timing exceptions
# btn_reset drives an async reset tree — exclude from setup/hold analysis
set_false_path -from [get_ports btn_reset]

# UART RX input: constrain so Vivado guides IO placement, but no real setup requirement
set_input_delay -clock sys_clk_pin -max 5.000 [get_ports uart_txd_in]
set_input_delay -clock sys_clk_pin -min 0.000 [get_ports uart_txd_in]

# UART TX and LEDs are asynchronous outputs — receiver/eye uses its own reference, no setup constraint
set_false_path -to [get_ports uart_rxd_out]
set_false_path -to [get_ports {spk_out_led[*]}]
set_false_path -to [get_ports rst_led]
