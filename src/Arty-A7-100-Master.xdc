...
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { rst_led }]; #IO_L19P_T3_35 Sch=led0_r
...
## LEDs
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { spk_out_led[0] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN J5    IOSTANDARD LVCMOS33 } [get_ports { spk_out_led[1] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { spk_out_led[2] }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { spk_out_led[3] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
...
set_input_delay  -clock sys_clk_pin -max 5.0 [get_ports uart_txd_in]
set_input_delay  -clock sys_clk_pin -min 0.0 [get_ports uart_txd_in]
